...
import { getGitHubOAuthUrl, getGoogleOAuthUrl } from "@/lib/api";
        ...
        <div className="glass rounded-2xl p-8 border border-white/10 shadow-2xl shadow-black/40">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-sm text-muted-foreground mt-1 text-center">
              Sign in to build your personalized AI/ML curriculum
            </p>
          </div>
          ...
          <div className="space-y-3">
            <a href={getGoogleOAuthUrl()} className="block">
              <Button
                variant="outline"
                className="w-full h-11 border-white/15 bg-white/5 hover:bg-white/10 hover:border-white/25 transition-all duration-200 gap-3"
              >
                {/* Google icon */}
